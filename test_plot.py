...
plt.figure()
plt.plot([1], [0.2662], marker='o', linestyle='dashed', linewidth=2, markersize=6)
plt.plot([1], [0.69], marker='o', linestyle='dashed', linewidth=2, markersize=6)
plt.ylim([0, 0.75])
plt.legend(['pcaGAN w/ correction', 'pcGAN w/o correction'])
plt.savefig('cfid_v_x_corr.png', bbox_inches='tight', dpi=300)